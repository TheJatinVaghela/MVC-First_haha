<section class="admin_Wrapper">
    ...
    <aside class="Admin_sidebar position-fixed top-0 left-0 overflow-auto h-100 float-left" id="show-side-navigation1">
    <i class="uil-bars close-aside d-md-none d-lg-none" data-close="show-side-navigation1"></i>
    <div class="Admin_sidebar-header d-flex justify-content-center align-items-center px-3 py-4">
    ...
    <ul class="categories list-unstyled">
        ...
        <ul class="Admin_sidebar-dropdown list-unstyled">
        ...
        <ul class="Admin_sidebar-dropdown list-unstyled">
            <li><a href="#">Lorem ipsum</a></li>
            <li><a href="#">ipsum dolor</a></li>navbarAdmin_sidebar
            <li><a href="#">dolor ipsum</a></li>
            <li><a href="#">amet consectetur</a></li>
            <li><a href="#">ipsum dolor sit</a></li>
        </ul>

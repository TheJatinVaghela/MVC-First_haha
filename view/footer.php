<footer id="amy-colophon" class="amy-site-footer">
    ...
    <script src="<?php echo $this->jatin_made?>/admin.js" defer></script>
    <script type='text/javascript'
    ...
    <script type='text/javascript' id='wc-add-to-cart-js-extra'>
        /* <![CDATA[ */
        var wc_add_to_cart_params = { "ajax_url": "\/movie\/demo\/elementor-book-tickets\/wp-admin\/admin-ajax.php", "wc_ajax_url": "\/movie\/demo\/elementor-book-tickets\/?wc-ajax=%%endpoint%%", "i18n_view_cart": "View cart", "cart_url": "http:\/\/demo.amytheme.com\/movie\/demo\/elementor-book-tickets\/cart\/", "is_cart": "", "cart_redirect_after_add": "no" };
        /* ]]> */
    </script>
    <script type='text/javascript'
    ...
    <script type='text/javascript' id='woocommerce-js-extra'>
        /* <![CDATA[ */
        var woocommerce_params = { "ajax_url": "\/movie\/demo\/elementor-book-tickets\/wp-admin\/admin-ajax.php", "wc_ajax_url": "\/movie\/demo\/elementor-book-tickets\/?wc-ajax=%%endpoint%%" };
        /* ]]> */
    </script>
    <script type='text/javascript'
    ...
    <script type='text/javascript' id='wc-cart-fragments-js-extra'>
        /* <![CDATA[ */
        var wc_cart_fragments_params = { "ajax_url": "\/movie\/demo\/elementor-book-tickets\/wp-admin\/admin-ajax.php", "wc_ajax_url": "\/movie\/demo\/elementor-book-tickets\/?wc-ajax=%%endpoint%%", "cart_hash_key": "wc_cart_hash_433b72f0acd5d7a4f555c9890401fdca", "fragment_name": "wc_fragments_433b72f0acd5d7a4f555c9890401fdca", "request_timeout": "5000" };
        /* ]]> */
    </script>
    <script type='text/javascript'
